...
using LukaLukaModel.Modules;
using LukaLukaModel.Resources;
using Ookii.Dialogs.WinForms;

namespace LukaLukaModel.Nodes
{
    ...
    public abstract class Node<T> : INode where T : class
    {
        ...
        public void Rename()
        {
            ...
            while ( sInputDialog.ShowDialog() == DialogResult.OK )
            {
                ...
                {
                    MessageBox.Show( "Please enter a valid name.", "Luka Luka Model", MessageBoxButtons.OK,
        ...
        public void Import( string filePath )
        {
            ...
            if ( module == null )
                MessageBox.Show( "File could not be imported.", "Luka Luka Model", MessageBoxButtons.OK, MessageBoxIcon.Error );
            else
            {
        ...
        public void Export( string filePath )
        {
            ...
            if ( module == null )
                MessageBox.Show( "Node could not be exported.", "Luka Luka Model", MessageBoxButtons.OK, MessageBoxIcon.Error );
            else
            {
                ConfigurationList.Instance.DetermineCurrentConfiguration( filePath );
        ...
        public void Replace( string filePath )
        {
            ...
            if ( module == null )
                MessageBox.Show( "Node could not be replaced.", "Luka Luka Model", MessageBoxButtons.OK, MessageBoxIcon.Error );
            else
            {
                ConfigurationList.Instance.DetermineCurrentConfiguration( filePath );
