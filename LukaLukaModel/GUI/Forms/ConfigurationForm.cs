...
using LukaLukaLibrary.Archives.Farc;
...
namespace LukaLukaModel.GUI.Forms
{
    public partial class ConfigurationForm : Form
    {
        ...
        protected override void OnFormClosing( FormClosingEventArgs e )
        {
            ...
            {
                var result = MessageBox.Show( "You have unsaved changes. Do you want to save them?", "Luka Luka Model",
        ...
        private void OnRename( object sender, EventArgs e )
        {
                ...
                { WindowTitle = "Rename configuration", Input = configuration.Name } )
            {
                while ( inputDialog.ShowDialog( this ) == DialogResult.OK )
                {
                    ...
                    {
                        MessageBox.Show( "A configuration with the same name already exists.", "Luka Luka Model",
