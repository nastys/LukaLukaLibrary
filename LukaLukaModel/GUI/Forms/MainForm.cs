...
using LukaLukaModel.Nodes;
using LukaLukaModel.Nodes.IO;
using LukaLukaModel.Nodes.Misc;
using LukaLukaModel.Nodes.Wrappers;
    ...
    public partial class MainForm : Form
    {
        ...
        private bool AskForSavingChanges()
        {
            ...
            var result = MessageBox.Show(
                "You have unsaved changes. Do you want to save them?", "Luka Luka Model", MessageBoxButtons.YesNoCancel,
        ...
        private void OnAbout( object sender, EventArgs e )
        {
            ...
            mStringBuilder.AppendLine( "Based on Miku Miku Model 1.1.2 by Skyth." );
        ...
        public void OpenFile( string filePath )
        {
            ...
            {
                MessageBox.Show( "File could not be opened.", "Luka Luka Model", MessageBoxButtons.OK,
        ...
        private void OnCombineMotions( object sender, EventArgs e )
        {
            ...
            {
                MessageBox.Show( "Could not find suitable configuration for the file.", "Luka Luka Model",
